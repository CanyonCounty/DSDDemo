...
namespace DSDDemo
{
    public class OutlookPanelEx : Panel
    {
        ...
        public OutlookPanelEx()
        {
            ...
            //this.DoubleClick += new System.EventHandler(this.panel_DoubleClick);
        ...
        private void DrawHeader(Graphics graphics)
        {
            ...
            //using (Brush brush = new LinearGradientBrush(headerRect, _headerColor1, _headerColor2, LinearGradientMode.Horizontal))
            //using (Brush brush = new LinearGradientBrush(headerRect, _headerColor2, _headerColor1, LinearGradientMode.Horizontal))
            //using (Brush brush = new LinearGradientBrush(headerRect, _headerColor2, _headerColor1, LinearGradientMode.ForwardDiagonal))
            //using (Brush brush = new LinearGradientBrush(headerRect, _headerColor2, _headerColor1, LinearGradientMode.BackwardDiagonal))
            {
        ...
        private void panel_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                panel.AutoSize = true;
                panel.Height = _drawHeight;
            }
            else
            {
                _drawHeight = Height;
                panel.AutoSize = false;
                panel.Height = (_headerHeight + 1);
            }
        }
    }
}
